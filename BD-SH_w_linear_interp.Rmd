...
print(paste("Based on inspecting the forecast results, the first time the upper-confidence interval (at the 95% level) reaches 450 is ",time_upper_95,".",sep=""))
print(paste("Furthermore, based on inspecting the forecast results, the point estimate prediction reaches 450 at ",time_pt_first_pt,".",sep=""))
print(paste("Lastly, the first time the lower-confidence interval (at the 95% level) reaches 450 is ",time_upper_95,".",sep=""))
```

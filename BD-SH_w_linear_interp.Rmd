...
plot(co2, main = "Figure1: Monthly Mean CO2 Variation",
...
boxplot(co2 ~ cycle(co2), main="Figure7: Boxplot of CO2 (ppm) by month")
...
From Figure7: Seasonality is apparent across months. For instance, notice the increase in CO2 from the first quarter to the end of the second quarter (month 6), and then the decline in CO2 until October. 
...
# But the model fails to reject the null hypothesis, suggesting that the 

...
co2.sarima = arima(co2, order = c(2,1,2), seasonal = c(2,1,0), method = "CSS")
...
## Custom Model Selection Algorithm
...
arima.search <- get.best.arima(co2.df$ppm, maxord=c(4,4,4,4,4,4))
